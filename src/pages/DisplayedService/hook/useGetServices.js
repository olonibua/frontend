...
export var useGetServices = function () {
    var user = useUserContext().user;
    var getServices = function () { return __awaiter(void 0, void 0, void 0, function () {
        var headers, url, response, error_1;
    ...
    return { getServices: getServices };
};
